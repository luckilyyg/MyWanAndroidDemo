            ...
            public void success(BaseHttpBean baseHttpBean) {
                ...
                if (baseHttpBean != null) {
                    if (baseHttpBean.getErrorCode() == 0) {
                        List<KnowledgeListBean> listBean = (List<KnowledgeListBean>) baseHttpBean.getData();
...
//                if (baseHttpBean != null) {
//                    if (baseHttpBean.getErrorCode() == 0) {
//                        List<KnowledgeListBean> LoadbeanList = (List<KnowledgeListBean>) baseHttpBean.getData();
