...
//                        date = String.format("%d-%02d", mDp_datePicker.getYear(), mDp_datePicker.getMonth() + 1, mDp_datePicker.getDayOfMonth());
                        String year = "";
                        String date = "";
                        year=String.format("%d", mDp_datePicker.getYear());//%d整数类型（十进制）
                        date=String.format("%d", mDp_datePicker.getMonth() + 1);
//                        interfaceDateDialog.getTime(year,date);
                        dismiss();
