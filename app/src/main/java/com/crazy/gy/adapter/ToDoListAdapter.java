...
public class ToDoListAdapter extends BaseSectionQuickAdapter<TodoSection, BaseViewHolder> {
   private boolean isDone;
    public ToDoListAdapter(boolean isDone) {
        super(R.layout.todo_item_view, R.layout.todo_item_head, null);
        this.isDone=isDone;
    }
    ...
    protected void convertHead(BaseViewHolder helper, TodoSection item) {
        ...
        if (isDone) {
            helper.setTextColor(R.id.todo_head, mContext.getResources().getColor(R.color.black));
        } else {
