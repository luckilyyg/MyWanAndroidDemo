...
import com.crazy.gy.mvp.presenter.HomeDetailPresenter;
...
public class HomeDetailActivity extends mBaseActivity implements HomeDetailContract.view{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.menu_article_collect:
                if(Sharedpreferences_Utils.getInstance(HomeDetailActivity.this).getBoolean(ConstantUtil.ISLOGIN)){
                    if(!isCollect){
                    ...
                    startActivity(new Intent(HomeDetailActivity.this,mLoginActivity.class));
                }
                break;
            default:
                break;
